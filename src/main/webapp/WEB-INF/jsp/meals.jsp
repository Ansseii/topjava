...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <table class="table table-striped" id="meals">
            <thead>
            <tr>
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr data-mealExcess="${meal.excess}">
                    ...
                    <td>
                        <a><span class="fa fa-remove" onclick="deleteRow(${meal.id})"></span></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
